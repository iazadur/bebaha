        ...
        <>
            ...
            className='mx-auto'
                ...
                actions={[
                    ...
                    <div className="flex flex-col gap-x-2 justify-center items-center text-gray-400 hover:text-green-400" key="accept"><CheckOutlined className="rounded-full border hover:border-green-500 border-gray-500 p-2"  /><p>Accept</p></div>,
                ]}
            >
