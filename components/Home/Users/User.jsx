...
const User = () => {
    return (
        <div className='bg-cover bg-center w-full rounded-3xl relative' style={{ backgroundImage: `url("/img/azad.jpg")`, height: "550px" }}>
            <div className="top-80 absolute bg-gradient-to-b from-transparent to-gray-600 w-full pb-3 rounded-b-3xl">
